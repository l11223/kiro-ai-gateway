...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::account::start_oauth_login,
            commands::account::complete_oauth_login,
            commands::account::cancel_oauth_login,
            commands::account::reorder_accounts,
            commands::account::toggle_proxy_status,
            commands::account::warm_up_all_accounts,
            commands::account::warm_up_account,
            commands::account::export_accounts,
            commands::account::update_account_label,
            commands::account::import_v1_accounts,
            commands::account::import_from_db,
            commands::account::import_custom_db,
            commands::account::sync_account_from_db,
            commands::account::read_text_file,
